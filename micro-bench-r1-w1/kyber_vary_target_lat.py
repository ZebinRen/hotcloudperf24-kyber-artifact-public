...
workload_fio_options = [
    '--name=1 --rw=randread --cpus_allowed=1 --iodepth=1 --name=2 --rw=randwrite --cpus_allowed=2 --iodepth=1'
]
...
# read IOPS
if True:
    fig_save_path = 'r1-w1-read-iops.pdf'
...
# write IOPS
if True:
    fig_save_path = 'r1-w1-write-iops.pdf'
...
# read latency
if True:
    fig_save_path = 'r1-w1-read-latency-ms.pdf'
...
# write latency
if True:
    fig_save_path = 'r1-w1-write-latency.pdf'
