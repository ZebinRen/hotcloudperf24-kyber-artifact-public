...
read_target_latencies_ticks = [
    '50us', '100us', '250us', '500us', '1ms', '2ms', '5ms', '10ms'
]
read_target_latencies_values = [
    us_in_ns(x) for x in [50, 100, 250, 500, 1000, 2000, 5000, 10000]
]
write_target_latencies_ticks = [
    '20us', '50us', '100us', '250us', '500us', '1ms', '2ms', '5ms', '10ms'
]
write_target_latencies_values = [
    us_in_ns(x) for x in [20, 50, 100, 250, 500, 1000, 2000, 5000, 10000]
]
...
workload_fio_options = [
    '--name=1 --rw=randread --cpus_allowed=1 --iodepth=256 --name=2 --rw=randwrite --cpus_allowed=2 --iodepth=1'
]
    ...
    for cur_read_tick in read_target_latencies_ticks:
        ...
        for cur_write_tick in write_target_latencies_ticks:
            print(str(
                round(
                    np.average(
                        write_p99_lat_results[cur_workload_name][index]), 1)) +
                  ' & ',
                  end='')
            index += 1
        print('\\\\')
...
# read IOPS
if True:
    fig_save_path = 'r256-w1-read-iops.pdf'
...
# write IOPS
if True:
    fig_save_path = 'r256-w1-write-iops.pdf'
...
# read latency
if True:
    fig_save_path = 'r256-w1-read-latency-ms.pdf'
...
# write latency
if True:
    fig_save_path = 'r256-w1-write-latency.pdf'
